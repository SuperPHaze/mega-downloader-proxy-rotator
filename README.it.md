...
- **Interfaccia** a schede con cruscotto (velocità istantanea/media/picco/minima di sessione, ETA, tempo, contatori job) e una sezione proxy dedicata (vivi, validazione, scartati, ricariche), filtri job a pulsanti, tema chiaro/scuro, pausa/ripresa/annullo globali e per singolo job.
